...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (res != 0) return res;
                res = ((Date) stock2.get("date")).compareTo((Date) stock1.get("date"));
                if (res != 0) return res;
                Double change1, change2;
                if (stock1.containsKey("change")) change1 = (double) stock1.get("change");
                else change1 = (double) stock1.get("last") - (double) stock1.get("open");
                if (stock2.containsKey("change")) change2 = (double) stock2.get("change");
                else change2 = (double) stock2.get("last") - (double) stock2.get("open");
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Apple Inc.", "AAPL", 125.77, 123.43));
        stocks.add(new Stock("Fake Apple Inc.", "AAPL", 125.98, 123.43));
        stocks.add(new Stock("Fake Apple Inc.", "AAPL", 125.85, 123.43));
        stocks.add(new Stock("Fake Apple Inc.", "AAPL", 135.64, 123.43));
        stocks.add(new Stock("Fake Apple Inc.", "AAPL", 105.64, 123.43));
