...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        ...
        if(a instanceof Apt1Room)((Apt1Room)a).clean1Room();
        else if(a instanceof Apt2Room)((Apt2Room)a).clean2Rooms();
        else if(a instanceof Apt3Room)((Apt3Room)a).clean3Rooms();
    }
